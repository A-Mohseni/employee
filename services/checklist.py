...
def update_checklist(
    ...
    current_user_oid = ObjectId(current_user["user_id"]) if current_user.get("user_id") else None
    is_owner = current_user_oid in {existing.get("assigned_to"), existing.get("created_by")}
